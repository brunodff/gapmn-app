...
function writeRows(ss, sheetName, headers, rows, dedupeKey, fields) {
  ...
  },
  {
    ...
    category: "gerais",
    icon: "📨",
    title: "Extensão Envio NE ao Fornecedor",
    subtitle: "GAPMN — Envio NE ao Fornecedor (Chrome / Firefox)",
    tagline: "Arraste o PDF da NE assinada — o robô extrai o CNPJ e envia a convocação por e-mail",
    description:
      "Extensão para Chrome e Firefox que automatiza o envio da convocação ao fornecedor após a assinatura da NE. Basta arrastar o PDF da Nota de Empenho assinada para o painel da extensão: ela extrai automaticamente o número da NE, o CNPJ e o nome do fornecedor e dispara o e-mail de convocação com o PDF anexado. Os dados são integrados ao App GAP-MN via Supabase.",
    steps: [
      ...
      "Ative o 'Modo do desenvolvedor' (chave no canto superior direito)",
      "Clique em 'Carregar sem compactação' e selecione a pasta extraída",
      "O ícone 📨 aparece na barra — fixe-o clicando no ícone de quebra-cabeça → 📌",
      ...
      "⚠ No Firefox a extensão é temporária — reinstale sempre que fechar o navegador",
      "— USO DIÁRIO —",
      "Com a NE assinada em PDF, clique no ícone da extensão na barra do navegador",
      "Arraste o arquivo PDF da NE para a área de drop indicada (ou clique para selecionar)",
      "A extensão lê o PDF, extrai automaticamente: número da NE, CNPJ e nome do fornecedor",
      "Confirme os dados extraídos e ajuste o e-mail do fornecedor se necessário",
      "Clique 'Enviar' — o e-mail de convocação é disparado com o PDF da NE em anexo",
      "Use '📧 Enviar e-mail de teste' para verificar o layout antes do primeiro envio real",
    ],
    status: "ativo",
    extensaoDownload: "/gapmn-ne-fornecedor.zip",
  },
  {
    id: "ob-siloms",
    category: "gerais",
